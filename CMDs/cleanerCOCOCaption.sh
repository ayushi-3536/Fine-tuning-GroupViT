...
#PBS -N CC_newmcl
#PBS -S /bin/bash
#PBS -l hostlist=^trick,nodes=1:ppn=8,gpus=1,mem=20gb,walltime=24:00:00
...
./tools/dist_launch.sh new_run_gvit.py configs/newdataloader_group_vit_gcc_yfcc_30e.yml 1 --resume /misc/lmbraid21/sharmaa/checkpoints/group_vit_gcc_yfcc_30e-879422e0.pth --opts train.finetune.only_grouping=true --output /misc/lmbraid21/sharmaa/outputs/gs2_newmcl