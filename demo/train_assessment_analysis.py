...
def normalize_dict_values(dictionary):
    ...
    #     # Check if the value is a single value or a list
    #     # if isinstance(value, list):
    #         # Get the maximum value for the current key

    #         print("value", value)
    #         max_value = max(value)

    #         # Normalize the values by dividing each value by the maximum value
    #         normalized_values = [v / max_value for v in value]
    #     # else:
    #     #     # If the value is a single value, no normalization is needed
    #     #     normalized_values = [value]

    #     # Update the normalized_dict with the normalized values for the current key
...
def train_assessment(args, config):
    ...
    for idx, samples in enumerate(data_loader_train):
        ...
        # print("samples", samples['filename'])
        # print("samples filename type", type(samples['filename']))
        ...
        #print("val_directory", val_directory)
        ...
        #print("val_annotation_file", val_annotation_file)
        # Check if the annotation file exists
        # if val_annotation_file.exists():
        #     print(f"Annotation file found: {val_annotation_file}")
        # else:
        #     print(f"No corresponding annotation file found for {img_path}")
