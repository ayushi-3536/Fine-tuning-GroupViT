...
unique_labels = np.unique(stacked_labels)[:20]
...
plt.savefig('all_feat_tsne_plot_coco_1k.pdf', bbox_inches='tight')
# plt.show()
plt.close()
...
plt.legend(bbox_to_anchor=(1.05, 1.0), loc='upper left')
plt.savefig('proj_feat_origckpt_tsne_plot_coco_20label.pdf', bbox_inches='tight')
plt.close()
...
fig.text(0.04, 0.5, 'Dimension 2', va='center', rotation='vertical')
plt.legend(bbox_to_anchor=(1.05, 1.0), loc='upper left')
plt.savefig('proj_feat_ft_tsne_plot_coco_20label.pdf', bbox_inches='tight')
plt.close()
...
fig.text(0.04, 0.5, 'Dimension 2', va='center', rotation='vertical')
plt.legend(bbox_to_anchor=(1.05, 1.0), loc='upper left')
plt.savefig('proj_feat_ftge_tsne_plot_coco_20label.pdf', bbox_inches='tight')
plt.close()