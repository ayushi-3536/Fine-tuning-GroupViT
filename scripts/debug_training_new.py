...
from datasets import build_loader, build_dataloader, build_loader_sync, build_text_transform, imagenet_classes
...
def train(cfg):
    ...
    #     data_loader_train, data_loader_val, text_transform_train = build_loader_sync(cfg.data)
