...
class GroupViTTrainAssessment(EncoderDecoder):
    ...
    def get_all_feat(self,img_tensor, img_show):
            ...
            result_dict = {'grouped_image': group_result, 'grouped_img_tokens': grouped_img_tokens, 'group_feat':group_feat[-1]}
            return result_dict

    def text_analysis_get_all_feat(self,img_tensor, img_show):
            """Encode images with backbone and decode into a semantic segmentation
            map of the same size as input."""
