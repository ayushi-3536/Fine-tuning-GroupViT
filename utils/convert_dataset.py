...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default='/misc/lmbraid21/sharmaa/PASCALContext/VOCdevkit', help='pascal voc devkit path')
    parser.add_argument('--json_path', default='/misc/lmbraid21/sharmaa/PASCALContext/trainval_merged.json', help='annoation json filepath')
    parser.add_argument('-o', '--out_dir', default='/misc/lmbraid21/sharmaa/PASCALContext/', help='output path')
